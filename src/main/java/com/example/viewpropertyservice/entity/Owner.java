...
public class Owner {
    ...
    public Owner(int ownerId, String firstName, String lastName, String email, String mobileNumber, String password, LocalDateTime createdAt, List<Property> properties) {
